...
#Region "メンバ変数"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private _CommandTypeData As CommandType003Data
...
#Region "コンストラクタ"
    ...
    Public Sub New()
        ...
        Me._CommandTypeData = New CommandType003Data
    ...
    ''' <remarks></remarks>
    Public Sub New(command_type_data As CommandType003Data)
...
#Region "公開メソッド"
    ...
    Public Sub SetData() Implements ICommandType.SetData
        ...
        Me.PartsPlay1.GetData(Me._CommandTypeData.PartsPlay001Data1)

        Me.PartsPlay2.GetData(Me._CommandTypeData.PartsPlay001Data2)

        Me.PartsPlay3.GetData(Me._CommandTypeData.PartsPlay001Data3)
    ...
    Public Sub GetData() Implements ICommandType.GetData
        ...
        Me._CommandTypeData.DisplayString = String.Concat(Me.PartsTiming.PartsData.DisplayString, Me.PartsConditions1.PartsData.DisplayString, Me.PartsConditions2.PartsData.DisplayString, Me.PartsConditions3.PartsData.DisplayString, Me.PartsPlay1.PartsData.DisplayString, Me.PartsPlay2.PartsData.DisplayString, Me.PartsPlay3.PartsData.DisplayString)
